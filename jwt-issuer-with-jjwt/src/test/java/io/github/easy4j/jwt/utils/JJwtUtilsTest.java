...
class JJwtUtilsTest {
    ...
    @Test void shouldGenerateAccessToken() { var u = new JJwtUtils(); assertThat(u.genAccessToken(key, "uid", "u", "i", "a", new HashMap<>(), 3600000)).isNotNull(); }
    @Test void shouldGenerateRefreshToken() { var u = new JJwtUtils(); assertThat(u.genRefreshToken(key, "uid", "u", "i", "a", new HashMap<>(), 7200000)).isNotNull(); }
