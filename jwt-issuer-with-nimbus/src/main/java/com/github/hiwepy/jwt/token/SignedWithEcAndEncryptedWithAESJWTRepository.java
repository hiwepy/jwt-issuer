...
public class SignedWithEcAndEncryptedWithAESJWTRepository implements JwtKeyPairRepository<ECKey,SecretKey> {
	 ...
	 */
	@Override
	public String issueJwt(ECKey signingKey, SecretKey secretKey, String jwtId, String subject, String issuer, Set<String> audience,
	 ...
	 */
	@Override
	public boolean verify(ECKey signingKey, SecretKey secretKey, String token, boolean checkExpiry) throws JwtException {
	 ...
	 */
	@Override
	public JwtPayload getPlayload(ECKey signingKey, SecretKey secretKey, String token, boolean checkExpiry)  throws JwtException {
		try {
