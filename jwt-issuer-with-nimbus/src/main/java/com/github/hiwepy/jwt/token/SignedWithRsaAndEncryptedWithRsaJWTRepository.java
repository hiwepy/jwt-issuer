...
public class SignedWithRsaAndEncryptedWithRsaJWTRepository implements JwtKeyPairRepository<RSAKey, RSAKey> {
	 ...
	 */
	@Override
	public boolean verify(RSAKey signingKey, RSAKey secretKey, String token, boolean checkExpiry) throws JwtException {
	 ...
	 */
	@Override
	public JwtPayload getPlayload(RSAKey signingKey, RSAKey secretKey, String token, boolean checkExpiry)  throws JwtException {
		try {
